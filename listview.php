                     ...
                     <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item "><a class="rd-nav-link" href="Registration.php">Registration</a>
					   ...
					   <li class="rd-nav-item"><a class="rd-nav-link" href="contacts.php">Contacts</a>
					    ...
					    <li class="rd-nav-item active"><a class="rd-nav-link" href="list.php">View</a>
                      </li>
...
$sql = "select * from registration where id='".$vartemp."'";
if($result = mysqli_query($conn, $sql)){
    if(mysqli_num_rows($result) > 0){
		...
		while($row = mysqli_fetch_array($result)){
					 ...
					 echo '<img src="'.$row['img'].'"  width="320px" height="220px"/>';
echo "<br>";
echo "<br>";
echo "<br>";
 ...
 echo "<tr class='border border-secondary'>";
           ...
           echo "<tr class='border border-secondary'>";
            ...
            echo "<tr class='border border-secondary'>";
                ...
                echo "<td class='p-2'>Registration person Name</td>";
