    ...
    <div class="page">
      ...
      <section class="bg-gray-7">
        <div class="breadcrumbs-custom box-transform-wrap context-dark">
          <div class="container">
            <h3 class="breadcrumbs-custom-title">There are things that death cannot touch is true love.</h3>
            <div class="breadcrumbs-custom-decor"></div>
          </div>
          <div class="box-transform" style="background-image: url(images/family18.jpg);"></div>
        </div>
        <div class="container">
            ...
            <div class="col-lg-8">
              ...
              <form class="rd-form rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                <div class="row row-20 gutters-20">
                  ...
                  <div class="col-md-6">
                    <div class="form-wrap">
                      <input class="form-input" id="contact-address-5" type="address" name="message" data-constraints="@Required">
                      <label class="form-label" for="contact-address-5">Your City</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-wrap">
                ...
                <div class="row row-30">
                  ...
                  <div class="col-sm-6 col-lg-12 aside-contacts-item">
                    ...
                    <div class="unit unit-spacing-xs justify-content-center justify-content-md-start">
                      ...
                      <div class="unit-body"><a class="mail" href="mailto:#">saudade@gmail.com</a></div>
                    </div>
                  </div>
                  <div class="col-sm-6 col-lg-12 aside-contacts-item">
