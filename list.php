    ...
    <div class="page">
                ...
                <div class="rd-navbar-right rd-navbar-nav-wrap">
                  ...
                  <div class="rd-navbar-main">
                    ...
                    <ul class="rd-navbar-nav">
					  ...
					  <li class="rd-nav-item"><a class="rd-nav-link" href="view.php">view</a>
                      </li>
      ...
      <section class="bg-gray-7">
        <div class="breadcrumbs-custom box-transform-wrap context-dark">
          <div class="container">
            <h3 class="breadcrumbs-custom-title">It's the little memories that will last a lifetime.</h3>
            <div class="breadcrumbs-custom-decor"></div>
          </div>
          <div class="box-transform" style="background-image: url(images/family1.jpg);"></div>
        </div>
        <div class="container">
          <ul class="breadcrumbs-custom-path">
            <li><a href="index.html">Home</a></li>
            <li class="active">Deceased People</li>
          </ul>
        </div>
      </section>
	  <!-- Tell-->
	  <section class="section section-sm section-first bg-default">
        <div class="container">
          <h3 class="heading-3">News Obituaries</h3>
...
?>
				<div align="center">
                 ...
                 <?php echo '<img src="'.$row['img'].'" width="30%" alt="" style="float:left; margin:10px;">'?>
				<span>
					<h4 style="text-align:justify;"><?php echo $row['dname']?>(<?php echo $row['ddate']?>)</h4>
					<p style="text-align:justify;"><?php echo $row['dname']?> death place is <?php echo " ".$row['dplace']." "?> on<?php echo " ".$row['ddate']." "?>.and reason of the death is <?php echo " ".$row['cause']." " ?>.he/she is <?php echo " ".$row['age']." "?>year old.......</p>
				  

				</span>
				<a class="button button-xs button-secondary button-winona wow fadeInRight" href="listview.php?id=<?php echo $row['id'];?>" data-wow-delay=".2s">View</a>
              </div>
			  <hr style="width:50%; height:1px; border-width:0; color:black; background-color:gray;">
