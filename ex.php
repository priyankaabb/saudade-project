                  ...
                  <div class="rd-navbar-main">
                    <!-- RD Navbar Nav-->
                     <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="typography.html">Registration</a>
                      </li>
...
$sql = "select * from flower where id='".$vartemp."'";
	if($result = mysqli_query($conn, $sql)){
		...
		if(mysqli_num_rows($result) > 0)
		{
				...
				{
					echo "<div class='row'>";
					 echo "<div class='fs-1 fw-bolder col-md-4 '>" .'<img src="'.$row['img'].'" width="200px" height="200px"/>'. "<br>";
					echo $row['name']. "<br>";
					 echo  $row['price'] . "</div>";
...
<div class="container">
  <form  action="#" class="bg-secondary.bg-gradient ">
  <div class="row">
  <div class="col-md-6">
  
        <input type="text" class="p-3" id="pwd" placeholder="Enter name" name="pwd">
    </div>
    
    <div class=" col-md-6">
	
        <input type="email" class="p-3" id="email" placeholder="Enter email" name="email">
     
    </div>
	</div>
	<div class="row">
    <div class=" col-md-6">
        <input type="text" class="p-3" id="pwd" placeholder="Enter Address" name="pwd">
      
    </div>
	<div class="col-md-6">
        <input type="text" class="p-3" id="pwd" placeholder="Enter contact_no" name="pwd">
    </div>
    </div>
     <div class="row">
    <div class=" col-md-12">
...
Enter message here...</textarea>
      ...
      <div class=" mt-3 ">
<button type="button " class="p-3 btn btn-dark btn-lg" onclick="return confirm('are you sure to send this flower!');">click here for send flower</button>
